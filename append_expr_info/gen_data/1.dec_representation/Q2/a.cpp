...
#ifdef LEN_2
    int prec[] = {6,6,6,6,15,15,15,15};
    int scale[] = {2,2,2,2,2,2,2,2};
    string file = "./LEN_2/data.tbl";
#elif LEN_4
    int prec[] = {6,6,6,6,33,33,33,33};
    int scale[] = {2,2,2,2,2,2,2,2};
    string file = "./LEN_4/data.tbl";
#elif LEN_8
    int prec[] = {6,6,6,6,69,69,69,69};
    int scale[] = {2,2,2,2,2,2,2,2};
    string file = "./LEN_8/data.tbl";
#elif LEN_16
    int prec[] = {6,6,6,6,141,141,141,141};
    int scale[] = {2,2,2,2,2,2,2,2};
    string file = "./LEN_16/data.tbl";
#elif LEN_32
    int prec[] = {6,6,6,6,285,285,285,285};
    int scale[] = {2,2,2,2,2,2,2,2};
