...
/**
 ** \file location.hh
 ** Define the aries::location class.
 */

#ifndef YY_ARIES_LOCATION_HH_INCLUDED
# define YY_ARIES_LOCATION_HH_INCLUDED
...
namespace aries_parser
{
    ...
    public:
        ...
        explicit position( unsigned l = 1u, unsigned c = 1u )
                : line( l ), column( c )
        {
        }
    ...
    public:
        ...
        explicit location( unsigned l, unsigned c = 1u )
                : begin( l, c ), end( l, c )
        {
        }
...
#endif // !YY_ARIES_LOCATION_HH_INCLUDED
