...
#include "./include/m_string.h"  /* for memcpy and NOT_FIXED_DEC */
#include "./include/my_config.h"
#include "./include/mysql_def.h"
...
int set_real(double num,uint decimals, char* buff, int size/*const CHARSET_INFO *cs*/)
{
    // uint dummy_errors;
    size_t len;
    ...
    {
        len= my_gcvt(num, MY_GCVT_ARG_DOUBLE, size - 1, buff, NULL);
