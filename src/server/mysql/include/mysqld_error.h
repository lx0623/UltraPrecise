...
static const int errmsg_section_start[] = { 1000, 3000, 60000 };
static const int errmsg_section_size[] = { 887, 230, 2 };
...
#define ER_INTERVAL_COMMON 3229
#define ER_CANNOT_ADD_DICT 60000
#define ER_TOO_MANY_DICT_ITEMS 60001
#endif
