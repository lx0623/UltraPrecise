...
{ "ER_OUT_OF_RESOURCES", 1041, "Out of memory; check if rateup or some other process uses all available memory; if not, you may have to use \'ulimit\' to allow rateup to use more memory or you can add more swap space" },
...
{ "ER_UNSUPPORTED_EXTENSION", 1112, "Table \'%-.192s\' uses an extension that doesn\'t exist in this Rateup version" },
...
{ "ER_TOO_MANY_TABLES", 1116, "Too many tables; Rateup can only use %d tables in a join" },
...
{ "ER_STACK_OVERRUN", 1119, "Thread stack overrun:  Used: %ld of a %ld stack.  Use \'rateup --thread_stack=#\' to specify a bigger stack if needed" },
...
{ "ER_HOST_NOT_PRIVILEGED", 1130, "Host \'%-.64s\' is not allowed to connect to this Rateup server" },
{ "ER_PASSWORD_ANONYMOUS_USER", 1131, "You are using Rateup as an anonymous user and anonymous users are not allowed to change passwords" },
{ "ER_PASSWORD_NOT_ALLOWED", 1132, "You must have privileges to update tables in the rateup database to be able to change passwords for others" },
...
{ "ER_NOT_ALLOWED_COMMAND", 1148, "The used command is not allowed with this Rateup version" },
{ "ER_SYNTAX_ERROR", 1149, "You have an error in your SQL syntax; check the manual that corresponds to your Rateup server version for the right syntax to use" },
...
{ "ER_NO_RAID_COMPILED", 1174, "This version of Rateup is not compiled with RAID support" },
...
{ "ER_TRANS_CACHE_FULL", 1197, "Multi-statement transaction required more than \'max_binlog_cache_size\' bytes of storage; increase this rateup variable and try again" },
...
{ "ER_MASTER_INFO", 1201, "Could not initialize master info structure; more error messages can be found in the Rateup error log" },
...
{ "ER_NOT_SUPPORTED_YET", 1235, "This version of Rateup doesn\'t yet support \'%s\'" },
...
{ "ER_NOT_SUPPORTED_AUTH_MODE", 1251, "Client does not support authentication protocol requested by server; consider upgrading Rateup client" },
...
{ "ER_SLAVE_IGNORED_SSL_PARAMS", 1274, "SSL parameters in CHANGE MASTER are ignored because this Rateup slave was compiled without SSL support; they can be used later if Rateup slave with SSL is started" },
...
{ "ER_MISSING_SKIP_SLAVE", 1278, "It is recommended to use --skip-slave-start when doing step-by-step replication with START SLAVE UNTIL; otherwise, you will get problems if you get an unexpected slave\'s rateup restart" },
...
{ "ER_WARN_HOSTNAME_WONT_WORK", 1285, "Rateup is started in --skip-name-resolve mode; you must restart it without this switch for this grant to work" },
...
{ "ER_FEATURE_DISABLED", 1289, "The \'%s\' feature is disabled; you need Rateup built with \'%s\' to have it working" },
{ "ER_OPTION_PREVENTS_STATEMENT", 1290, "The Rateup server is running with the %s option so it cannot execute this statement" },
...
{ "ER_RESERVED_SYNTAX", 1382, "The \'%-.64s\' syntax is reserved for purposes internal to the Rateup server" },
...
{ "ER_STACK_OVERRUN_NEED_MORE", 1436, "Thread stack overrun:  %ld bytes used of a %ld byte stack, and %ld bytes needed.  Use \'rateup --thread_stack=#\' to specify a bigger stack." },
...
{ "ER_SP_PROC_TABLE_CORRUPT", 1457, "Failed to load routine %-.192s. The table rateup.proc is missing, corrupt, or contains bad data (internal code %d)" },
...
{ "ER_MIX_HANDLER_ERROR", 1497, "The mix of handlers in the partitions is not allowed in this version of Rateup" },
...
{ "ER_EVENT_OPEN_TABLE_FAILED", 1545, "Failed to open rateup.event" },
{ "ER_EVENT_NEITHER_M_EXPR_NOR_M_AT", 1546, "No datetime expression provided" },
{ "ER_OBSOLETE_COL_COUNT_DOESNT_MATCH_CORRUPTED", 1547, "Column count of rateup.%s is wrong. Expected %d, found %d. The table is probably corrupted" },
{ "ER_OBSOLETE_CANNOT_LOAD_FROM_TABLE", 1548, "Cannot load from rateup.%s. The table is probably corrupted" },
{ "ER_EVENT_CANNOT_DELETE", 1549, "Failed to delete the event from rateup.event" },
...
{ "ER_WARN_DEPRECATED_SYNTAX_WITH_VER", 1554, "The syntax \'%s\' is deprecated and will be removed in Rateup %s. Please use %s instead" },
...
{ "ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE", 1558, "Column count of rateup.%s is wrong. Expected %d, found %d. Created with Rateup %d, now running %d. Please use mysql_upgrade to fix this error." },
...
{ "ER_NDB_REPLICATION_SCHEMA_ERROR", 1625, "Bad schema for rateup.ndb_replication table. Message: %-.64s" },
...
{ "ER_STMT_CACHE_FULL", 1705, "Multi-row statements required more than \'max_binlog_stmt_cache_size\' bytes of storage; increase this rateup variable and try again" },
...
{ "ER_INSECURE_CHANGE_MASTER", 1760, "Storing Rateup user name or password information in the master info repository is not secure and is therefore not recommended. Please consider using the USER and PASSWORD connection options for START SLAVE; see the \'START SLAVE Syntax\' in the Rateup Manual for more information." },
...
{ "ER_SLAVE_CONFIGURATION", 1794, "Slave is not configured or failed to initialize properly. You must at least set --server-id to enable either a master or a slave. Additional error messages can be found in the Rateup error log." },
...
{ "ER_MTS_RECOVERY_FAILURE", 1803, "Cannot recover after SLAVE errored out in parallel execution mode. Additional error messages can be found in the Rateup error log." },
{ "ER_MTS_RESET_WORKERS", 1804, "Cannot clean up worker info tables. Additional error messages can be found in the Rateup error log." },
...
{ "ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE_V2", 3009, "Column count of %s.%s is wrong. Expected %d, found %d. Created with Rateup %d, now running %d. Please use mysql_upgrade to fix this error." },
...
{ "ER_FEATURE_NOT_AVAILABLE", 3110, "The \'%-.64s\' feature is not available; you need to remove \'%-.64s\' or use Rateup built with \'%-.64s\'" },
...
{ "ER_WARN_ON_MODIFYING_GTID_EXECUTED_TABLE", 3129, "Please do not modify the %s table. This is a rateup internal system table to store GTIDs for committed transactions. Modifying it can lead to an inconsistent GTID state." },
...
{ "ER_INTERVAL_COMMON", 3229, "Interval error occurred: %s" },
{ "ER_CANNOT_ADD_DICT", 60000, "Cannot add dict encode constraint" },
{ "ER_TOO_MANY_DICT_ITEMS", 60001, "Too many dict items" },
