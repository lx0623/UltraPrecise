...
#define ARIES_SM_TAG sm_53
#elif __CUDA_ARCH__ >= 520
#define ARIES_SM_TAG sm_52
#elif __CUDA_ARCH__ >= 500
#define ARIES_SM_TAG sm_50
#elif __CUDA_ARCH__ == 370
#define ARIES_SM_TAG sm_37
#elif __CUDA_ARCH__ >= 350
#define ARIES_SM_TAG sm_35
#elif __CUDA_ARCH__ == 320
#define ARIES_SM_TAG sm_32
#elif __CUDA_ARCH__ >= 300
#define ARIES_SM_TAG sm_30
#elif __CUDA_ARCH__ >= 210
#define ARIES_SM_TAG sm_21
#elif __CUDA_ARCH__ >= 200
#define ARIES_SM_TAG sm_20
#else
#error "Aries Modern GPU v3 does not support builds for sm_1.x"
#endif
#else // __CUDA_ARCH__
#define ARIES_SM_TAG sm_00
#endif

#define ARIES_LAUNCH_PARAMS(launch_box) \
  typename launch_box::ARIES_SM_TAG
#define ARIES_LAUNCH_BOUNDS(launch_box) \
  __launch_bounds__(launch_box::sm_ptx::nt, launch_box::sm_ptx::occ) 

BEGIN_ARIES_ACC_NAMESPACE

    struct ARIES_ALIGN(8) cta_dim_t
    {
        int nt, vt;
        int nv() const
        {
...
// branching on cta < num_ctas.
        ...
        ARIES_DEVICE void restrict_forward( func_t f, int tid, int cta, int num_ctas, args_t ... args )
        {
...
// Generic thread cta kernel.
    ...
    __global__ ARIES_LAUNCH_BOUNDS(launch_box)
...
//    }
    ...
    struct launch_cta_t
    {
        enum
        {
            nt = nt_, vt = vt_, vt0 = vt0_, occ = occ_
        };
    };
