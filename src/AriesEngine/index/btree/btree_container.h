...
// btree_multimap.
    ...
    public:
        ...
        {
            return tree_.lower_bound_first_key( key );
        }
        ...
        {
            return tree_.upper_bound_first_key( key );
        }
        ...
        {
            return tree_.equal_range_first_key( key );
        }
...
// A common base class for btree_set and safe_btree_set.
    ...
    public:
        ...
        btree_unique_container( InputIterator b, InputIterator e, const key_compare &comp = key_compare(), const allocator_type &alloc =
                allocator_type() )
                : super_type( comp, alloc )
        {
            insert( b, e );
        ...
        {
            return this->tree_.find_unique_first_key( key );
        }
        ...
        std::pair< iterator, bool > insert( const key_type& key, const value_type &x )
        {
            return this->tree_.insert_unique( key, &x );
        }
...
// A common base class for btree_map and safe_btree_map.
    ...
    public:
        ...
        // Range constructor.
        template< class InputIterator >
        btree_map_container( InputIterator b, InputIterator e, const key_compare &comp = key_compare(), const allocator_type &alloc =
                allocator_type() )
...
// A common base class for btree_multiset and btree_multimap.
    ...
    public:
        ...
        // Range constructor.
        template< class InputIterator >
        btree_multi_container( InputIterator b, InputIterator e, const key_compare &comp = key_compare(), const allocator_type &alloc =
                allocator_type() )
                : super_type( comp, alloc )
        {
            insert( b, e );
        ...
        iterator find_first_key( const key_type &key )
        {
            return this->tree_.find_multi_first_key( key );
        }
        const_iterator find_first_key( const key_type &key ) const
        {
            return this->tree_.find_multi_first_key( key );
        ...
        iterator insert( const key_type &key, const value_type &x )
        {
            return this->tree_.insert_multi( key, &x );
        }
        iterator insert( iterator position, const value_type &x )
        {
